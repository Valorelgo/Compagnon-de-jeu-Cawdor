...
const db = {
    ...
    // ===== TERRITOIRES (19) =====
    territories: [
        { id: "ter_settlement", name: "Settlement", income: 15, optionType: "discount_ganger", optionText: "Option : Recruter un ganger (-25 cr sur coût)", desc: "Revenu : 15 cr OU recruter un ganger pour 25 cr de moins.", battle_effect: "Aucun effet en jeu." },
        { id: "ter_bullet_den", name: "Bullet den", income: 15, optionType: "discount_ammojack", optionText: "Option : Recruter un Ammo-jack (-30 cr sur coût)", desc: "Revenu : 15 cr OU recruter un Ammo-jack pour 30 cr de moins.", battle_effect: "Durant la partie, une fois par round, un guerrier peut recharger gratuitement son arme." },
        { id: "ter_rogue_doc_shop", name: "Rogue doc shop", income: 15, optionType: "discount_doc", optionText: "Option : Recruter un Rogue doc (-30 cr sur coût)", desc: "Revenu : 15 cr OU recruter un Rogue doc pour 30 cr de moins.", battle_effect: "Quand un guerrier en assiste un autre, on ajoute un dé de blessure supplémentaire." },
        { id: "ter_mess_shack", name: "Mess Shack", income: 15, optionType: "discount_slopper", optionText: "Option : Recruter un Slopper (-30 cr sur coût)", desc: "Revenu : 15 cr OU recruter un Slopper pour 30 cr de moins.", battle_effect: "Tous les guerriers ont +1 en Ld.", statBonus: { stat: "Ld", delta: 1 } },
        { id: "ter_drinking_hole", name: "Drinking hole", income: 15, optionType: "discount_watcher", optionText: "Option : Recruter un Hive watcher (-30 cr sur coût)", desc: "Revenu : 15 cr OU recruter un Hive watcher pour 30 cr de moins.", battle_effect: "Aucune arme de tir ne peut être utilisée au premier round." },
        { id: "ter_fence_hangout", name: "Fence hangout", income: 15, optionType: "discount_runner", optionText: "Option : Recruter un Dome runner (-30 cr sur coût)", desc: "Revenu : 15 cr OU recruter un Dome runner pour 30 cr de moins.", battle_effect: "Les missions secondaires rapportent D3×10 crédits en plus." },
        { id: "ter_bounty_den", name: "Bounty den", income: 25, desc: "Revenu : 25 crédits.", battle_effect: "Les joueurs génèrent une deuxième mission secondaire." },
        { id: "ter_generatorium", name: "Generatorium", income: 15, passive: "+1 Réputation", desc: "Revenu : 15 cr. Passif : +1 Réputation tant que contrôlé.", battle_effect: "La règle Visibilité (X\") ne peut être jouée." },
        { id: "ter_corpse_farm", name: "Corpse farm", income: 25, desc: "Revenu : 25 crédits.", battle_effect: "Les gangs gagnent 10 crédits pour chaque ennemi mis hors de combat." },
        { id: "ter_tunnels", name: "Tunnels", income: 20, desc: "Revenu : 20 crédits.", battle_effect: "La règle Tunnel warfare est en jeu : un seul étage sur les décors, les échelles ne peuvent être utilisées, et on ne peut pas grimper sur les murs." },
        { id: "ter_tech_bazaar", name: "Tech bazaar", income: 15, passive: "+1 TP", desc: "Revenu : 15 cr. Passif : +1 TP au Trading Post.", battle_effect: "Les armes avec les traits explosion ou gabarit ne peuvent pas être utilisées au premier round." },
        { id: "ter_promethium_cache", name: "Promethium cache", income: 15, optionType: "items_suits", optionText: "Option : 3 Combinaisons de protection gratos", desc: "Revenu : 15 cr OU récupérer gratuitement 3 combinaisons de protection dans le Stash.", battle_effect: "Toutes les armes avec le trait flammes (X+) améliorent cet effet de 1." },
        { id: "ter_collapsed_dome", name: "Collapsed dome", income: 20, desc: "Revenu : 20 crédits.", battle_effect: "Lors des tests d'agilité, un résultat naturel de 1 entraîne une blessure L1 automatique sans sauvegarde." },
        { id: "ter_bone_shrine", name: "Bone shrine", income: 25, desc: "Revenu : 25 crédits.", battle_effect: "Le défenseur place un marqueur dans les 6\" autour du centre : les guerriers peuvent marquer de l'XP en le contrôlant, comme un objectif principal." },
        { id: "ter_mine_workings", name: "Mine workings", income: 20, optionType: "items_respirators", optionText: "Option : 2 Respirateurs gratos", desc: "Revenu : 20 cr OU récupérer gratuitement 2 respirateurs dans le Stash.", battle_effect: "La règle Visibilité (18\") est en jeu." },
        { id: "ter_gambling_den", name: "Gambling den", income: 15, passive: "+1 Réputation", desc: "Revenu : 15 cr. Passif : +1 Réputation tant que contrôlé.", battle_effect: "Une fois par partie, chaque joueur peut relancer un unique dé." },
        { id: "ter_synth_still", name: "Synth still", income: 20, desc: "Revenu : 20 crédits.", battle_effect: "L'AP de toutes les armes avec toxine (X+) a un bonus de +1." },
        { id: "ter_old_ruins", name: "Old ruins", income: 20, desc: "Revenu : 20 crédits.", battle_effect: "Quand un guerrier est à portée longue d'une arme et sans couvert, il améliore sa Sv de 1." },
        { id: "ter_fighting_pit", name: "Fighting pit", income: 25, desc: "Revenu : 25 crédits.", battle_effect: "Quand un guerrier inflige un Sérieusement blessé ou un OOA, il gagne 1 XP supplémentaire." }
    ],
