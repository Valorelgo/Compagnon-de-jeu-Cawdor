                ...
                <div style="margin-top:8px; padding:6px 8px; background:#111; border:1px solid #333; border-radius:4px; font-size:11px;">
                    ...
                    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(105px, 1fr)); gap:4px;">
                        ...
                        <div style="display:flex; align-items:center; gap:3px;">
                            ...
                            <button class="btn" style="padding:0 4px; font-size:10px;" ${lx.objective >= 1 ? 'disabled title="Déjà gagné pour cette partie"' : ''} onclick="adjLiveXP(${idx}, 'objective', 1)">+</button>
                        </div>
                        <div style="display:flex; align-items:center; gap:3px;">
        ...
        <div style="padding: 6px 0;">
            <div style="background: rgba(230, 126, 34, 0.12); border: 1px solid #e67e22; border-radius: 8px; padding: 14px; margin-bottom: 16px;">
                ...
                <div style="font-size: 13.5px; line-height: 1.6; color: #eee;">
                    ...
                    ${(typeof getGangAlignment === 'function' && getGangAlignment(currentGang) === 'fanatic') ? `
                        <div style="margin-top: 10px; padding: 6px 10px; background: rgba(243,156,18,0.12); border: 1px solid #f39c12; border-radius: 6px; color: #f39c12; font-size: 12px;">
                            🔥 <strong>Fanatical</strong> : si le résultat total (D6 + pertes) est 11 ou 12, vous pouvez relancer le D6 avant d'enregistrer le résultat ci-dessous.
                        </div>
                    ` : ''}
                    ${isAlreadyBottled ? `
