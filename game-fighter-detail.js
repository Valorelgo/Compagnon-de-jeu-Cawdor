                    ...
                    <div style="background:#181818; padding:12px; border-radius:6px; border:1px solid #333;">
                        ...
                        <div style="overflow-x:auto;">
                            <table style="margin:0;">
                                <thead>
                                    <tr>
                                        <th style="width: 24%; text-align:left; padding-left:6px;">Arme</th>
                                        ...
                                        <th style="width: 16%;">Traits</th>
                                        <th style="width: 13%;">Munitions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    ` : combatItems.map(({ item: w, isGrenade, listType, itemIndex }) => {
                                        ...
                                        return profiles.map((prof, pIdx) => {
                                            const profLabel = (prof.name && prof.name.toLowerCase() !== 'unique') ? prof.name : '-';
                                            return `
                                            <tr>
