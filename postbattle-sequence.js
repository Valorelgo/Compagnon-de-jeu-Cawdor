...
function transferFighterGearToStash(m) {
    ...
    if (m.equipment && Array.isArray(m.equipment)) {
        m.equipment.forEach(e => {
            ...
            // reprendre depuis la même catégorie d'équipement "Familiers". Il faut
            // pour cela impérativement conserver familiarCharId sur l'objet du
            // stash (sinon la reprise ne sait plus quel personnage recréer).
